"""
Django settings for SASEASU project.
...
ROOT_URLCONF = 'SASEASU.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, "SASEASU/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'SASEASU.wsgi.application'
